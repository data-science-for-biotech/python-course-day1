...
*   It's common to write them using a text editor but we are going to use Jupyter Notebooks in
    Visual Studio Code.
...
*   Open a new notebook by hitting <kbd>Ctrl</kbd><kbd>Shift</kbd><kbd>P</kbd> (or .<kbd>Cmd</kbd><kbd>Shift</kbd><kbd>P</kbd> on a Mac) and typing "new notebook" to find the "Create: New Jupyter Notebook" option.
